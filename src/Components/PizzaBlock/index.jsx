...
function PizzaBlock({id, name, imageUrl, price, sizes, types, onClickAddPizza, cartCount}) {
    ...
    return (
        <div className="pizza-block">
            ...
            <div className="pizza-block__selector">
                <ul>
                    {
                        typesName.map( (type, index) => <li 
                        key={type} onClick={() => setType(index)} className={ClassNames({
                ...
                <ul>
                {
                        allSizes.map( (type, index) => <li 
                        key={type} onClick={() => setSize(index)} className={ClassNames({
